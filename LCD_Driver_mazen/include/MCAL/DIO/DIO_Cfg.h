...
#define PORTA_PIN4_DIRECTION DIO_CFG_OUTPUT
#define PORTA_PIN5_DIRECTION DIO_CFG_OUTPUT
#define PORTA_PIN6_DIRECTION DIO_CFG_OUTPUT
#define PORTA_PIN7_DIRECTION DIO_CFG_OUTPUT
