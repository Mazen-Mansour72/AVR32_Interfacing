...
//Port Direction: DIO_CFG_OUTPUT or DIO_CFG_INPUT
...
#define PORTD_PIN0_DIRECTION DIO_CFG_INPUT
...
#define PORTD_PIN5_DIRECTION DIO_CFG_INPUT
#define PORTD_PIN6_DIRECTION DIO_CFG_INPUT
#define PORTD_PIN7_DIRECTION DIO_CFG_INPUT

/* Port Value:
DIO_CFG_OUTPUT => DIO_CFG_HIGH    or DIO_CFG_LOW
DIO_CFG_INPUT  => DIO_CFG_PULL-UP or DIO_CFG_FLOATING */
...
#define PORTA_PIN1_VALUE DIO_CFG_PULLUP
#define PORTA_PIN2_VALUE DIO_CFG_PULLUP
#define PORTA_PIN3_VALUE DIO_CFG_PULLUP
...
#define PORTB_PIN3_VALUE DIO_CFG_PULLUP
#define PORTB_PIN4_VALUE DIO_CFG_PULLUP
#define PORTB_PIN5_VALUE DIO_CFG_PULLUP
#define PORTB_PIN6_VALUE DIO_CFG_PULLUP
#define PORTB_PIN7_VALUE DIO_CFG_PULLUP

#define PORTC_PIN0_VALUE DIO_CFG_FLOATING
#define PORTC_PIN1_VALUE DIO_CFG_PULLUP
#define PORTC_PIN2_VALUE DIO_CFG_PULLUP
#define PORTC_PIN3_VALUE DIO_CFG_PULLUP
#define PORTC_PIN4_VALUE DIO_CFG_PULLUP
#define PORTC_PIN5_VALUE DIO_CFG_PULLUP
#define PORTC_PIN6_VALUE DIO_CFG_PULLUP
#define PORTC_PIN7_VALUE DIO_CFG_PULLUP

#define PORTD_PIN0_VALUE DIO_CFG_FLOATING
#define PORTD_PIN1_VALUE DIO_CFG_PULLUP
#define PORTD_PIN2_VALUE DIO_CFG_PULLUP
#define PORTD_PIN3_VALUE DIO_CFG_PULLUP
#define PORTD_PIN4_VALUE DIO_CFG_PULLUP
#define PORTD_PIN5_VALUE DIO_CFG_PULLUP
#define PORTD_PIN6_VALUE DIO_CFG_PULLUP
#define PORTD_PIN7_VALUE DIO_CFG_PULLUP
